...
export const MODULES: ModuleDef[] = [
  {
    ...
    questions: [
      ...
      { id: 'nivel_educativo', label: '¿Cuál es el nivel educativo más alto que ha alcanzado?', subtitle: 'Seleccione una opción.', type: 'pills', options: ['Primaria completa / incompleta', 'Bachillerato completo / incompleto', 'Técnico o Tecnológico', 'Universitario o Posgrado', 'Ninguno'], route: 'adulto' },
